    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i22 = 0; _i22 < _size20; ++_i22) {
          var elem23 = null;
          elem23 = new ttypes.ColumnChunk();
          elem23.read(input);
          this.columns.push(elem23);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i26 = 0; _i26 < _size24; ++_i26) {
          var elem27 = null;
          elem27 = new ttypes.SortingColumn();
          elem27.read(input);
          this.sorting_columns.push(elem27);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
RowGroup.prototype.write = function(output) {
  ...
  if (this.columns !== null && this.columns !== undefined) {
    ...
    for (var iter28 in this.columns) {
      if (this.columns.hasOwnProperty(iter28)) {
        iter28 = this.columns[iter28];
        iter28.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.sorting_columns !== null && this.sorting_columns !== undefined) {
    ...
    for (var iter29 in this.sorting_columns) {
      if (this.sorting_columns.hasOwnProperty(iter29)) {
        iter29 = this.sorting_columns[iter29];
        iter29.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i32 = 0; _i32 < _size30; ++_i32) {
          var elem33 = null;
          elem33 = new ttypes.PageLocation();
          elem33.read(input);
          this.page_locations.push(elem33);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OffsetIndex.prototype.write = function(output) {
  ...
  if (this.page_locations !== null && this.page_locations !== undefined) {
    ...
    for (var iter34 in this.page_locations) {
      if (this.page_locations.hasOwnProperty(iter34)) {
        iter34 = this.page_locations[iter34];
        iter34.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i37 = 0; _i37 < _size35; ++_i37) {
          var elem38 = null;
          elem38 = input.readBool();
          this.null_pages.push(elem38);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i41 = 0; _i41 < _size39; ++_i41) {
          var elem42 = null;
          elem42 = input.readBinary();
          this.min_values.push(elem42);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ColumnIndex.prototype.write = function(output) {
  ...
  if (this.null_pages !== null && this.null_pages !== undefined) {
    ...
    for (var iter51 in this.null_pages) {
      if (this.null_pages.hasOwnProperty(iter51)) {
        iter51 = this.null_pages[iter51];
        output.writeBool(iter51);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.min_values !== null && this.min_values !== undefined) {
    ...
    for (var iter52 in this.min_values) {
      if (this.min_values.hasOwnProperty(iter52)) {
        iter52 = this.min_values[iter52];
  ...
  if (this.max_values !== null && this.max_values !== undefined) {
    ...
    for (var iter53 in this.max_values) {
      if (this.max_values.hasOwnProperty(iter53)) {
        iter53 = this.max_values[iter53];
        output.writeBinary(iter53);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.null_counts !== null && this.null_counts !== undefined) {
    ...
    for (var iter54 in this.null_counts) {
      if (this.null_counts.hasOwnProperty(iter54)) {
        iter54 = this.null_counts[iter54];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i57 = 0; _i57 < _size55; ++_i57) {
          var elem58 = null;
          elem58 = new ttypes.SchemaElement();
          elem58.read(input);
          this.schema.push(elem58);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i61 = 0; _i61 < _size59; ++_i61) {
          var elem62 = null;
          elem62 = new ttypes.RowGroup();
          elem62.read(input);
          this.row_groups.push(elem62);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i65 = 0; _i65 < _size63; ++_i65) {
          var elem66 = null;
          elem66 = new ttypes.KeyValue();
          elem66.read(input);
          this.key_value_metadata.push(elem66);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i69 = 0; _i69 < _size67; ++_i69) {
          var elem70 = null;
          elem70 = new ttypes.ColumnOrder();
          elem70.read(input);
          this.column_orders.push(elem70);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
FileMetaData.prototype.write = function(output) {
  ...
  if (this.schema !== null && this.schema !== undefined) {
    ...
    for (var iter71 in this.schema) {
      if (this.schema.hasOwnProperty(iter71)) {
        iter71 = this.schema[iter71];
        iter71.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.row_groups !== null && this.row_groups !== undefined) {
    ...
    for (var iter72 in this.row_groups) {
      if (this.row_groups.hasOwnProperty(iter72)) {
        iter72 = this.row_groups[iter72];
        iter72.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.key_value_metadata !== null && this.key_value_metadata !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.key_value_metadata.length);
    for (var iter73 in this.key_value_metadata) {
      if (this.key_value_metadata.hasOwnProperty(iter73)) {
        iter73 = this.key_value_metadata[iter73];
        iter73.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.column_orders !== null && this.column_orders !== undefined) {
    ...
    for (var iter74 in this.column_orders) {
      if (this.column_orders.hasOwnProperty(iter74)) {
        iter74 = this.column_orders[iter74];
        iter74.write(output);
      }
    }
    output.writeListEnd();
